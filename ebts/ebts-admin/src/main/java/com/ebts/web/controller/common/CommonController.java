package com.ebts.web.controller.common;
...
import com.ebts.common.utils.file.FileUploadUtils;
import com.ebts.common.utils.file.FileUtils;
import com.ebts.framework.config.ServerConfig;
...
//            }
            ...
            String filePath = EBTSConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception {
        try {
            // 上传文件路径
            String filePath = EBTSConfig.getUploadPath();
            // 上传并返回新文件名称
...
//            String url = serverConfig.getUrl() + fileName;
    ...
    public void resourceDownload(String name, HttpServletRequest request, HttpServletResponse response) throws Exception {
        // 本地资源路径
        String localPath = EBTSConfig.getProfile();
        // 数据库资源地址
