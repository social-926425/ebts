...
import com.ebts.system.dao.DeptDao;
...
public class DeptServiceImpl implements DeptService {
    ...
    public String checkDeptNameUnique(Dept dept) {
        try {
            ...
            Dept info = sysDeptDao.checkDeptNameUnique(dept.getDeptName(), dept.getParentId());
    ...
    public int insertDept(Dept dept) {
        try {
            Dept info = sysDeptDao.selectDeptById(dept.getParentId());
    ...
    public int updateDept(Dept dept) {
        try {
            Dept newParentDept = sysDeptDao.selectDeptById(dept.getParentId());
            Dept oldDept = sysDeptDao.selectDeptById(dept.getDeptId());
    ...
    public void updateDeptChildren(Long deptId, String newAncestors, String oldAncestors) {
        try {
            List<Dept> children = sysDeptDao.selectChildrenDeptById(deptId);
