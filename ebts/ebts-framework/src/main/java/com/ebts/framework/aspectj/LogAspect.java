package com.ebts.framework.aspectj;
...
import com.ebts.common.enums.BusinessStatus;
import com.ebts.common.enums.HttpMethod;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.ebts.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            // 保存数据库
            AsyncDao.me().execute(AsyncFactory.recordOper(operLog));
        } catch (Exception exp) {
            // 记录本地异常日志
            log.error("==前置通知异常==");
